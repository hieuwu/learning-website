...
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Angular - The Complete Guide (2021 Edition)','Master Angular 10 (formerly "Angular 2")','<p><strong>Andie Information</strong></p> <ul>     <li>Master Angular 10 (formerly "Angular 2") and build awesome, reactive web apps with the successor of Angular.js</li> </ul>',99.99,19.97,430688,"unfinished",1,3);
...
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete JavaScript Course 2021','The modern JavaScript course for everyone','<p><strong>Cousre Information</strong></p> <ul>     <li>The modern JavaScript course for everyone! Master JavaScript with projects, challenges and theory. Many courses in one!</li> </ul>',299.99,169.97,386157,"unfinished",1,5);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Web Developer Bootcamp 2020','Learning about HTML,CSS, etc','<p><strong>Jewelry Information</strong></p> <ul>     <li>The only course you need to learn web development - HTML, CSS, JS, Node, and More!</li> </ul>',399.99,369.97,430688,"unfinished",1,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('iOS & Swift - The Complete iOS App Development Bootcamp','Learning about iOS','<p><strong>Information</strong></p> <ul>     <li><p><strong>Information</strong></p> <ul>     <li>From Beginner to iOS App Developer with Just One Course! Fully Updated with a Comprehensive Module Dedicated to SwiftUI</li> </ul></li> </ul>',499.99,169.97,430688,"unfinished",2,2);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete Android N Developer Course','Learn Android App Development','<p><strong>Information</strong></p> <ul>     <li>Learn Android App Development with Android 7 Nougat by building real apps including Uber, Whatsapp and Instagram</li> </ul>',499.99,169.97,430688,"unfinished",2,3);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete React Native + Hooks Course','Understand React Native v0.62.2 with Hooks, Context, and React Navigation','<p><strong>Information</strong></p> <ul>     <li><p><strong>Information</strong></p> <ul>     <li>If you are tired of spinning your wheels learning Swift or Android, this is the course for you.Authentication? You will learn it.  Hooks? Included.  Navigation? Of course!This course will get you up and running with React Native quickly, and teach you the core knowledge you need to deeply understand and build React components for mobile devices.</li> </ul></li> </ul>',129.99,99.97,430688,"unfinished",2,4);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('iOS 11 & Swift 4 - The Complete iOS App Development Bootcamp','Learn iOS 11 App Development From Beginning to End.','<p><strong>Information</strong></p> <ul>     <li>Learn iOS 11 App Development From Beginning to End. Using Xcode 9 and Swift 4. Includes Full ARKit and CoreML Modules!</li> </ul>',169.99,100,148083,"unfinished",2,5);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Flutter & Dart - The Complete Guide','Guide to the Flutter SDK & Flutter Framework','<p><strong>Information</strong></p> <ul>     <li>A Complete Guide to the Flutter SDK & Flutter Framework for building native iOS and Android apps</li> </ul>',11.99,6.96,138872,"unfinished",2,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Complete C# Unity Game Developer 2D','Learning about Android','<p><strong>Information</strong></p> <ul>     <li>Learn C#, a powerful modern language, from scratch. No prior programming experience is necessary</li> </ul>',199,129.99,116732,"unfinished",3,2);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Unreal Engine C++ Developer: Learn C++ and Make Video Games','Created in collaboration with Epic Games.','<p><strong>Information</strong></p> <ul>     <li>Created in collaboration with Epic Games. Learn C++ from basics while making your first 4 video games in Unreal</li> </ul>',60.99,30.34,112677,"unfinished",3,3);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Complete C# Unity Game Developer 3D','Design & Develop Video Games.','<p><strong>Information</strong></p> <ul>     <li>Design & Develop Video Games. Learn C# in Unity Engine. Code Your first 3D Unity games for web, Mac & PC.</li> </ul>',150,129.99,375524,"unfinished",3,4);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('RPG Core Combat Creator: Learn Intermediate Unity C# Coding','Build Combat for Role Playing Game (RPG) in Unity.','<p><strong>Information</strong></p> <ul>     <li>Build Combat for Role Playing Game (RPG) in Unity. Tutorials Cover Code Architecture & Video Game Design.</li> </ul>',199,80,430688,"finished",3,5);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Ultimate Guide to Game Development with Unity 2019','learn C# by developing 2D & 3D games','<p><strong>Information</strong></p> <ul>     <li>Created in partnership with Unity Technologies: learn C# by developing 2D & 3D games with this comprehensive guide</li> </ul>',209,11,430688,"unfinished",3,6);

insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('2020 Complete Python Bootcamp From Zero to Hero in Python','Learn Python like a Professional','<p><strong>Information</strong></p> <ul>     <li>Learn Python like a Professional Start from the basics and go all the way to creating your own applications and games</li> </ul>',150,129.99,1181699,"unfinished",4,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Java Programming Masterclass for Software Developers','Learn Java In This Course And Become a Computer Programmer.','<p><strong>Information</strong></p> <ul>     <li>Learn Java In This Course And Become a Computer Programmer. Obtain valuable Core Java Skills And Java Certification</li> </ul>',113,89,530164,"unfinished",4,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Python Mega Course: Build 10 Real World Applications','A complete practical Python course for both beginners & intermediates','<p><strong>Information</strong></p> <ul>     <li>A complete practical Python course for both beginners & intermediates! Master Python 3 by making 10 amazing Python apps.</li> </ul>',127.99,99.99,207440,"unfinished",4,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('React - The Complete Guide (incl Hooks, React Router, Redux)','Dive in and learn React.js from scratch','<p><strong>Information</strong></p> <ul>     <li>Dive in and learn React.js from scratch! Learn Reactjs, Hooks, Redux, React Routing, Animations, Next.js and way more!</li> </ul>',19.99,12.99,250307,"unfinished",4,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Learn Python Programming Masterclass','This Python For Beginners Course Teaches You The Python Language Fast','<p><strong>Information</strong></p> <ul>     <li>This Python For Beginners Course Teaches You The Python Language Fast. Includes Python Online Training With Python 3</li> </ul>',209,129.99,267876,"unfinished",4,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Become a Product Manager | Learn the Skills & Get the Job','The most complete course available on Product Management.','<p><strong>Information</strong></p> <ul>     <li>The most complete course available on Product Management. 13+ hours of videos, activities, interviews, & more</li> </ul>',129.99,99.99,122579,"unfinished",5,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete Management Skills Certification Course','Used at Amazon, Unilever, Walmart','<p><strong>Information</strong></p> <ul>     <li>Used at Amazon, Unilever, Walmart, and other top firms. Learn leadership, productivity, communication skills & more!</li> </ul>',199.99,99.99,30174,"unfinished",5,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete Product Management Course','Learn the skills, tools, and processes needed to become an irreplaceable PM.','<p><strong>Information</strong></p> <ul>     <li>Learn the skills, tools, and processes needed to become an irreplaceable PM. Examples from NASA, Google, Zappos, Apple</li> </ul>',19.99,9.99,17363,"unfinished",5,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Leadership: Practical Leadership Skills','Master leadership skills and leadership techniques with this highly practical advice and training','<p><strong>Information</strong></p> <ul>     <li>Chris Croft is an international speaker, and widely published author, who is been teaching Leadership Skills to companies for over 20 years. He is taught all over the world, as well as online, and has an entertaining and practical teaching style. This course is guaranteed to keep you engaged and amused, and teach you life changing skills for home and work</li> </ul>',99.99,69.99,79434,"unfinished",5,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Management Skills - Team Leadership Skills Masterclass 2020','Leadership & Business Skills','<p><strong>Information</strong></p> <ul>     <li>Leadership & Management Skills - Change Management- Lean BPM Management Skills - Team Management - Team Building</li> </ul>',129.69,60.99,29563,"unfinished",5,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Sales Training: Practical Sales Techniques','Sales Hacking!','<p><strong>Information</strong></p> <ul>     <li>Sales Hacking: Essential sales skills, sales strategies and sales techniques to sell just about anything!</li> </ul>',129.99,99.99,42541,"unfinished",6,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Business Development For Startups and Tech Companies','Unlock massive growth using the business development channel.','<p><strong>Information</strong></p> <ul>     <li>Unlock massive growth using the business development channel. Learn pitching, BD strategy, cold emailing, & deal closing</li> </ul>',159.99,129.99,32344,"unfinished",6,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Business Development & B2B Sales for Startups- Sales Valley','The Complete Startup Playbook','<p><strong>Information</strong></p> <ul>     <li>The Complete Startup Playbook for Business Development & B2B Sales to learn Lead Generation, Pitching, & Closing Deals.</li> </ul>',169.96,149.99,18905,"unfinished",6,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Learn to Sell Anything by Grant Cardone','Sell anything in your hands','<p><strong>Information</strong></p> <ul>     <li>Learn sales basics, techniques, and strategies that will give you the skills to sell anything.</li> </ul>',50,49.99,15750,"unfinished",6,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('LinkedIn Marketing, Lead Generation & B2B Sales for LinkedIn','LinkedIn Machine: The LinkedIn MasterClass','<p><strong>Information</strong></p> <ul>     <li>LinkedIn Machine: The LinkedIn MasterClass to learn LinkedIn Marketing, Lead Generation, Business Development, B2B Sales</li> </ul>',130,119.99,16184,"unfinished",6,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Bookkeeping Basics #1: Understand the Fundamentals','Learn bookkeeping terms','<p><strong>Information</strong></p> <ul>     <li>Learn bookkeeping terms and concepts to make owners, employees & students more confident and successful!</li> </ul>',99.99,74.99,12443,"unfinished",7,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Introduction to Finance, Accounting, Modeling and Valuation','Learn Finance & Accounting','<p><strong>Information</strong></p> <ul>     <li>Learn Finance & Accounting from Scratch by an Award Winning MBA Professor, Ivy Grad, worked @ Goldman & VC</li> </ul>',130,109.9,15159,"unfinished",7,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Financial Accounting - #1 Ranked University: Course 1 of 5','Honored by the President of the United States.','<p><strong>Information</strong></p> <ul>     <li>Learn accounting from the self-made millionaire Norm Nemrow and the recipient of a famed teaching award from the President of the United States. This course is produced by the #1 accounting university in the world</li> </ul>',199.99,99.99,21219,"unfinished",7,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Accounting & Financial Statement Analysis: Complete Training','Accounting & Financial Ratio Analysis made easy','<p><strong>Information</strong></p> <ul>     <li>Learn important accounting skills that will get your foot in the door!</li> </ul>',209,129.99,41092,"unfinished",7,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Accounting: From Beginner to Advanced!','#1 accounting course online.','<p><strong>Information</strong></p> <ul>     <li>Learn accounting like never before. Learn easy and fast. Easy to understand Accounting. #1 accounting course online.</li> </ul>',209.99,119.99,179,"unfinished",7,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete Investment Banking Course 2020','The #1 Course to Land a Job in Investment Banking.','<p><strong>Information</strong></p> <ul>     <li>The #1 Course to Land a Job in Investment Banking. IPOs, Bonds, M&A, Trading, LBOs, Valuation: Everything is included!</li> </ul>',139.99,49.99,94618,"unfinished",8,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Financial Management A Complete Study for CA/CMA/CS/CFA/ACCA','500+ lectures & case studies for CA IPCC,etc','<p><strong>Information</strong></p> <ul>     <li>500+ lectures & case studies for CA IPCC / CFA / CS Final / CMA Inter / MBA Finance / B. Com Final Exams & Professionals</li> </ul>',289,149.63,11691,"unfinished",8,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('The Complete Financial Analyst Training & Investing Course','Succeed as a Financial Analyst &Investor','<p><strong>Information</strong></p> <ul>     <li>The  Succeed as a Financial Analyst &Investor course by Award Winning MBA Prof who worked @Goldman, in Hedge Funds & Venture Capital</li> </ul>',209,199.99,19364,"unfinished",9,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('CCNA 2020 200-125 Video Boot Camp With Chris Bryant','Join The 90,000+ Students Who Are Learning Real-World Skills AND Earning Their CCNA!','<p><strong>Information</strong></p> <ul>     <li>My latest and greatest CCNA Video Boot Camp, specifically designed for the new 200-301 exam, is now live on Udemy.   Udemy doesnt allow me to link to it from here for some reason, but it is available now.</li> </ul>',29,19.99,102653,"unfinished",10,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('AWS Certified Solutions Architect - Associate 2020','AWS Solutions Architect - Associate Exam?','<p><strong>Information</strong></p> <ul>     <li>Want to pass the AWS Solutions Architect - Associate Exam? Want to become Amazon Web Services Certified? Do this course!</li> </ul>',12,9.99,8134,"unfinished",10,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Ultimate AWS Certified Developer Associate 2021 - NEW!','Become an AWS Certified Developer!','<p><strong>Information</strong></p> <ul>     <li>Become an AWS Certified Developer! Learn all Amazon Web Services Developer topics. PASS the AWS Certified Developer Exam</li> </ul>',154,129.99,165634,"unfinished",10,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('AWS Certified Developer - Associate 2020','Do you want AWS certification?','<p><strong>Information</strong></p> <ul>     <li>Do you want AWS certification? Do you want to be an AWS Certified Developer Associate? This AWS online course is for you</li> </ul>',98.99,64,198565,"unfinished",10,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Ultimate AWS Certified Solutions Architect Associate 2021','the AWS Certified Solutions Architect Associate Certification SAA-C02.','<p><strong>Information</strong></p> <ul>     <li>Pass the AWS Certified Solutions Architect Associate Certification SAA-C02. Complete Amazon Web Services Cloud training!</li> </ul>',129.99,119.99,23465,"unfinished",10,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Learn Ethical Hacking From Scratch','Become an ethical hacker','<p><strong>Information</strong></p> <ul>     <li>Become an ethical hacker that can hack computer systems like black hat hackers and secure them like security experts.</li> </ul>',129,99.99,401976,"unfinished",11,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('PLC Programming From Scratch','give a person with no prior experience the basic tools','<p><strong>Information</strong></p> <ul>     <li>This course will give a person with no prior experience the basic tools necessary to create a PLC program from scratch.</li> </ul>',29.99,19.99,4963,"unfinished",12,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Pianoforall - Incredible New Way To Learn Piano & Keyboard','Learn Piano in WEEKS not years.','<p><strong>Information</strong></p> <ul>     <li>Play-By-Ear & learn to Read Music. Pop, Blues, Jazz, Ballads, Improvisation, Classical</li> </ul>',150.15,50.05,1999999,"unfinished",13,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Ultimate Beginner Guitar Masterclass','Beginner guitar lessons.','<p><strong>Information</strong></p> <ul>     <li>Beginner guitar lessons. Go from knowing nothing about the guitar and learn to play songs everbody loves in just weeks</li> </ul>',9.99,6.96,43068,"unfinished",13,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Complete Guitar System - Beginner to Advanced','All-in-one Guitar Course With a Proven Step-by-step Learning System.','<p><strong>Information</strong></p> <ul>     <li>I have learned soooo much from Erichs lessons! I have had my guitar for less than 5 months and I have such a firm foundation and core understanding of the principles and techniques I need. The sky is the limit, If my fingers can catch up to my brain</li> </ul>',19,3.69,430688,"unfinished",13,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('BECOME A GREAT SINGER: Your Complete Vocal Training System','Any Level, Any Style','<p><strong>Information</strong></p> <ul>     <li>Immediately Improve Your Singing</li> </ul>',199.99,36.99,4688,"unfinished",14,6);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher) values('Read Music FAST!','Learn to read music using my unique method','<p><strong>Information</strong></p> <ul>     <li>using my unique method: just see a note on a piano score and play it on the keyboard straight away</li> </ul>',209,11,430688,"unfinished",15,6);
