...
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher,avgRate) values('iOS & Swift - The Complete iOS App Development Bootcamp','Learning about iOS','<p><strong>Information</strong></p> <ul>     <li><p><strong>Information</strong></p> <ul>     <li>From Beginner to iOS App Developer with Just One Course! Fully Updated with a Comprehensive Module Dedicated to SwiftUI</li> </ul></li> </ul>',499.99,169.97,430688,"unfinished",2,2,1);
insert into course(nameCourse,title,Description,Price,SaleCost,nOViews,status,IdCategory,IdTeacher,avgRate) values('The Complete Android N Developer Course','Learn Android App Development','<p><strong>Information</strong></p> <ul>     <li>Learn Android App Development with Android 7 Nougat by building real apps including Uber, Whatsapp and Instagram</li> </ul>',499.99,169.97,430688,"unfinished",2,3,2);
